<template>
    <v-row dense class="gap-2">
        ...
        <v-col cols="12" class="d-flex gap-4 justify-between">
            <v-btn @click="openAddEditProductDialog('Add', {})" class="bg-primary" height="40px">Add Product</v-btn>
            <v-btn to="categories" class="bg-primary" height="40px">Switch to Product Categories</v-btn>
            <!-- <v-text-field
                hide-details
                placeholder="Search..."
            ></v-text-field> -->
